...
namespace Syntax
{
    internal static class SyntaxSH
    {
        ...
        public static string Commands = @"\b(accept|access|aclocal|aconnect|acpi|acpi_available|acpid|addr2line|addresses|agetty|alias|alsactl|amidi|amixer|" +
                                        ...
                                        @"zcat|zcmp|zdiff|zdump|zforce|zgrep|zic|zless|zmore|znew)\b|apt\-get\b|dnssec-keygen\b|dnssec-makekeyset\b|dnssec-signkey\b|dnssec-signzone\b|"+
                                        @"esd-config\b|fc-cache\b|fc-list\b|g\+\+\b|iptables-restore\b|iptables-save\b|mkfs.ext3\b|mklost+found\b|notify-send\b|sane-find-scanner\b|"+
